...
import src.models.craft_text_detector.file_utils as file_utils
import src.models.craft_text_detector.torch_utils as torch_utils
...
def load_craftnet_model(
    ...
    weight_path = "src/models/craft_text_detector/models/craft_mlt_25k.pth"

    # load craft net
    from src.models.craft_text_detector.models.craftnet import CraftNet
...
def load_refinenet_model(
    ...
    weight_path = "src/models/craft_text_detector/models/craft_refiner_CTW1500.pth"

    # load refine net
    from src.models.craft_text_detector.models.refinenet import RefineNet
